...
public class PageOnePagerAdapter3 extends PagerAdapter {
    ...
    public PageOnePagerAdapter3(List<Integer> items, Context context) {
        mContext = context;
        mItems = items;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        // 佈局
        View itemView = mInflater.inflate(R.layout.pageone_pageradapter3_item, container, false);
