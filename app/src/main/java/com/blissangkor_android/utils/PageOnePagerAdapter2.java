...
public class PageOnePagerAdapter2 extends PagerAdapter {
    ...
    public PageOnePagerAdapter2(List<Integer> items, Context context) {
        mContext = context;
        mItems = items;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        // 佈局
        View itemView = mInflater.inflate(R.layout.pageone_pageradapter2_item, container, false);
