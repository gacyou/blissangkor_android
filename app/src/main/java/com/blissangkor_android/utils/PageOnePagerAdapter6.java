...
public class PageOnePagerAdapter6 extends PagerAdapter {
    ...
    public PageOnePagerAdapter6(List<Integer> items, Context context) {
        mContext = context;
        mItems = items;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        // 佈局
        View itemView = mInflater.inflate(R.layout.pageone_pageradapter6_item, container, false);
