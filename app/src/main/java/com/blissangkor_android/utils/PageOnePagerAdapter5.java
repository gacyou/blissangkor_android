...
public class PageOnePagerAdapter5 extends PagerAdapter {
    ...
    public PageOnePagerAdapter5(List<Integer> items, Context context) {
        mContext = context;
        mItems = items;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        // 佈局
        View itemView = mInflater.inflate(R.layout.pageone_pageradapter5_item, container, false);
